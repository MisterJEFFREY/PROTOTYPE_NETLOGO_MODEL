...
to setup
  clear-all
  set text (word "Why is it that when I eat a bowl of magnets, I still can't attract any females?"
                ;; the next two sentences each contain all 26
                ;; letters of the alphabet!  (which makes them
                ;; good for testing typewriters)
                "I don't need no dollars to have fun tonight!"
                "As long I can feel good dancing")
  draw-margins
